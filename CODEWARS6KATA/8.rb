...
# of the sequence to generate the next. And, worse part of it, regrettably I won't get to hear non-native Italian speakers trying to pronounce it :(
...
def tribonacci(signature,n)
  if n == 1  
    ...
    (n-3).times do
   signature.push(signature[-3..-1].sum)
  end
   signature
  end  
end